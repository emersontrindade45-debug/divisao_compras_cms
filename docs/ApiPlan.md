...
(sessão distinta, sem tocar `src/lib/ingestao/`); contagem consolidada de "concluídas/pendentes"
fica para quem mesclar os três, já que os totais acima foram calculados antes desta tarefa.
